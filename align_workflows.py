...
def main(args):
    ...
    for sub_workflow in args.sub_workflows:
      ...
      DR = sandbDataReader()
      DR.load_data(data_file_name, workflow_version[workflow[sub_workflow]], args.start_date, args.end_date, args.subject_ids, args.classification_ids, args.volunteer_handles)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--volunteer-handles', nargs = '*', default = [], help = f'List volunteer user names to include. Put "" as the first id to exclude them instead.')
